...
matplot(incidence$day, t(history[1, , -1]), type = "l",
        xlab = "Time", ylab = "Number of individuals",
        col = cols[["S"]], lty = 1, ylim = range(history))
matlines(incidence$day, t(history[2, , -1]), col = cols[["I"]], lty = 1)
matlines(incidence$day, t(history[3, , -1]), col = cols[["R"]], lty = 1)
matpoints(incidence$day, t(true_history[1:3, , -1]), pch = 19,
          col = cols)
...
The sampler can now be run using these parameters, and the particle filter defined above. Taking 2000 steps with four independent chains:
