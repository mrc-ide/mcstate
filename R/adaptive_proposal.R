...
##'
##' Efficient exploration of the parameter space during an MCMC might be difficult when the target
##' distribution is of high dimensionality,
##' especially if the target probability distribution present a high degree of correlation.
##' Adaptive schemes are used to "learn" on the fly the correlation structure
##' by updating the proposal distribution by recalculating the empirical variance-covariance matrix
##' and rescale it at each adaptive step of the MCMC.
##' 
...
##'   accepted (optimally) for the adaptive part of the mixture model.
##'
...
##'   adaptive part of the proposal. The proposal is based on a mixture model, with the
##'   non adaptive part used for the proposal with a probability 1-adaptive_contribution.
##'
##' @export
